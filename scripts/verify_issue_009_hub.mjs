...
assert(!html.includes('class="hero-hotspots"'),'Removed hero shortcuts must not return; use the five numbered section tiles');
assert(!hubCss.includes('.hero-hotspots'),'Remove obsolete hero-shortcut CSS with the controls');
...
console.log('PASS: actual hub router, five isolated views, no redundant hero shortcuts, legacy/deep/unknown hashes, Home, Escape, focus return, Listen focus and one persistent player.');
